...
func (rm *resourceManager) newCreateRequestPayload(
	...
	if r.ko.Spec.HealthCheckConfig != nil {
		...
		if r.ko.Spec.HealthCheckConfig.FailureThreshold != nil {
			if *r.ko.Spec.HealthCheckConfig.FailureThreshold > math.MaxInt32 || *r.ko.Spec.HealthCheckConfig.FailureThreshold < math.MinInt32 {
				return nil, fmt.Errorf("error: field FailureThreshold is of type int32")
			}
			failureThresholdCopy := int32(*r.ko.Spec.HealthCheckConfig.FailureThreshold)
		...
		if r.ko.Spec.HealthCheckConfig.HealthThreshold != nil {
			if *r.ko.Spec.HealthCheckConfig.HealthThreshold > math.MaxInt32 || *r.ko.Spec.HealthCheckConfig.HealthThreshold < math.MinInt32 {
				return nil, fmt.Errorf("error: field HealthThreshold is of type int32")
			}
			healthThresholdCopy := int32(*r.ko.Spec.HealthCheckConfig.HealthThreshold)
		...
		if r.ko.Spec.HealthCheckConfig.Port != nil {
			if *r.ko.Spec.HealthCheckConfig.Port > math.MaxInt32 || *r.ko.Spec.HealthCheckConfig.Port < math.MinInt32 {
				return nil, fmt.Errorf("error: field Port is of type int32")
			}
			portCopy := int32(*r.ko.Spec.HealthCheckConfig.Port)
			f0.Port = &portCopy
		}
		...
		if r.ko.Spec.HealthCheckConfig.RequestInterval != nil {
			if *r.ko.Spec.HealthCheckConfig.RequestInterval > math.MaxInt32 || *r.ko.Spec.HealthCheckConfig.RequestInterval < math.MinInt32 {
				return nil, fmt.Errorf("error: field RequestInterval is of type int32")
			}
			requestIntervalCopy := int32(*r.ko.Spec.HealthCheckConfig.RequestInterval)
...
func (rm *resourceManager) terminalAWSError(err error) bool {
	...
	switch err.(type) {
	case *svcsdktypes.InvalidInput,
		*svcsdktypes.HealthCheckInUse:
		return true
	default:
		return false
	}
