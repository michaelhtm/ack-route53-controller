...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GeoProximityLocation) DeepCopyInto(out *GeoProximityLocation) {
	*out = *in
	if in.AWSRegion != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GeoProximityLocation.
func (in *GeoProximityLocation) DeepCopy() *GeoProximityLocation {
	if in == nil {
		return nil
	}
	out := new(GeoProximityLocation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceRecordSet) DeepCopyInto(out *ResourceRecordSet) {
	*out = *in
	...
	if in.GeoProximityLocation != nil {
		in, out := &in.GeoProximityLocation, &out.GeoProximityLocation
		*out = new(GeoProximityLocation)
		(*in).DeepCopyInto(*out)
	}
	if in.HealthCheckID != nil {
